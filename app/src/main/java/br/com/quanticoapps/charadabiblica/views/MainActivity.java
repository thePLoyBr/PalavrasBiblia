...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvMoedas = findViewById(R.id.id_moedas);
        ivMoedas = findViewById(R.id.iv_coin);

        if (userConvertido != "") {
            monitorDB(userConvertido);
        }



        Button btnInstrucoes = findViewById(R.id.btn_instrucoes);
        btnInstrucoes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder alertaInst = new AlertDialog.Builder(MainActivity.this);
                alertaInst.setTitle("");
                alertaInst
                        .setIcon(R.drawable.instrucoes)
                        .setMessage("1)- Coloque o celular com a tela virada para outra pessoa\n\n 2)- Seu amigo dá dicas para você adivinhar a palavra (pode ser mimica, ou palavras relacionadas (tipo mega-senha)\n\n 3)- Se adivinhou, gire a tela para baixo e vai contar o ponto\n\n 4)- Se não sabe a palavra, gire a tela para cima e passará a palavra.")
                        .setCancelable(true)
                ...
                AlertDialog alertDialogInst = alertaInst.create();
                alertDialogInst.show();
            }
        });


        ImageView btnFree = findViewById(R.id.id_btn_play);
        btnFree.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentFree = new Intent(MainActivity.this, GameActivity.class);
                startActivity(intentFree);
            }
        });

        btnCompras = findViewById(R.id.id_btn_loja);
        btnCompras.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent goScreenBuy = new Intent(MainActivity.this, ComprasActivity.class);
                startActivity(goScreenBuy);
            }
        });
        ...
        if (anuncios != "noAds") {
            ...
            tvMoedas.setVisibility(View.INVISIBLE);
            ivMoedas.setVisibility(View.INVISIBLE);
        }
    ...
    protected void onPostResume() {
        super.onPostResume();
        listaPalavrasInicial.clear();
        adicionaPacoteInicial();
        Log.i("listaInicial", String.valueOf(listaPalavrasInicial.size()));

        final ConnectivityManager conMgr = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
        final NetworkInfo activeNetwork = conMgr.getActiveNetworkInfo();
        if (activeNetwork != null && activeNetwork.isConnected()) {
            tvMoedas.setVisibility(View.VISIBLE);
            ivMoedas.setVisibility(View.VISIBLE);
            ...
            alerta
                    ...
                    .setMessage("Sem internet você não poderá ganhar moedas para comprar mais palavas.")
                    .setCancelable(false)
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Log.i("listaMain", String.valueOf(listaPalavrasInicial.size()));
            }
        }, 1000);
    }


    private void monitorDB(String path) {
        if (path != "") {
            myRef.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    tvMoedas.setText(dataSnapshot.child(userConvertido).child("coins").getValue().toString());
                }
